...
def printState():
        for i in range(nbPlayers):
                print "Player " , tabPlayers[i].name , " is on box ", tabPlayers[i].position , " and have ", tabPlayers[i].money, " euros"


#Impression d'une case
def printCase(pos) :
        print "\n-------------------------------------------"
        print "You are on box " , pos #rajouter les autres joueurs
        if Boxes[pos]["type"] == 0 :
                print "\n" , Boxes[pos]["name"]
                if Boxes[pos]["moveMoney"] <100 :
                        print "\n You lose " , Boxes[pos]["moveMoney"]
                else :
                        print "\n You win " , Boxes[pos]["moveMoney"]
